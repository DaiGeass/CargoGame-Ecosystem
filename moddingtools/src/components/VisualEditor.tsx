      ...
      <div className="flex-1 overflow-y-auto p-5">
        ...
        {filtered.length === 0 && (
          <div className="text-center py-16 max-w-md mx-auto">
            ...
            <div className="text-slate-300 font-bold text-lg mb-2">Sin cartas todavía</div>
            <div className="text-sm text-slate-500 mb-4">ModdingBuild recolecta el contenido <b>del juego en vivo</b>. Cuando se ejecute dentro de CARGAS, las cartas aparecerán aquí.</div>
            <div className="flex flex-wrap gap-2 justify-center">
              <button onClick={() => startNewCard()} className="bg-rose-600 hover:bg-rose-500 text-white text-sm font-bold px-4 py-2 rounded-lg">+ Crear carta</button>
            </div>
          </div>
        )}
      </div>
