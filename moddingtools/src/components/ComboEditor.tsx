...
import { Combo, getAllCombos } from '../data/cards';
...
export const ComboEditor: React.FC = () => {
  ...
  const [combos, setCombos] = useState<Combo[]>(getAllCombos());
      ...
      <main className="flex-1 overflow-y-auto p-5">
        {!sel ? (
          <div className="text-center py-16 max-w-md mx-auto">
            ...
            <div className="text-slate-300 font-bold text-lg mb-2">Sin combos todavía</div>
            <div className="text-sm text-slate-500 mb-4">Los combos se recolectan del juego. Crea uno nuevo combinando cartas existentes.</div>
            <button onClick={addCombo} className="bg-amber-600 hover:bg-amber-500 text-white text-sm font-black px-5 py-2 rounded-lg">+ Crear combo</button>
          </div>
        ) : (
